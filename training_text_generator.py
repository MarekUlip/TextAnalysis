...
class Training_Text_Generator(Sequence):
    def __init__(self, filename, batch_size, num_of_texts,num_of_words, tokenizer, delimeter, num_of_classes,start_point=0):
    ...
    def __getitem__(self, item):
        ...
        features = vectorize_sequences(self.tokenizer.texts_to_sequences(articles[:,1]),self.num_of_words).astype(np.uint8)
        articles = None
