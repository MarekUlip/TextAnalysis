...
while datasets_helper.next_dataset():
    ...
    model.add(Bidirectional(LSTM(enhanced_num_of_topics, activation='relu', dropout=0.1, recurrent_dropout=0.5),input_shape=(1,num_of_words)))#,dropout=0.1,recurrent_dropout=0.5,input_shape=(num_of_words,),return_sequences=True))
