...
results_saver = LogWriter(log_file_desc="simpleRNN")
results = []
num_of_words = 10000
...
while datasets_helper.next_dataset():
    ...
    model.add(SimpleRNN(30,dropout=0.1,recurrent_dropout=0.5,input_shape=(1,num_of_words),return_sequences=True))
